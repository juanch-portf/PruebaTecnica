...
public class Implementacion implements Metodos {
	...
	@Transactional
	@Modifying
	public Peliculas buscarNombre1(String nombre) {
		return dao.findByNombrePelicula(nombre);
	}
	...
	@Transactional
	@Modifying
	public void eliminarNombre1(String nombre) {
		dao.deleteByNombrePelicula(nombre);
